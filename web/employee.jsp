<%@ include file="includes/header.jsp" %>
  <%@ page import="java.util.*" %>
    <%@ page import="Model.*" %>
      <% Employee employeeDetails=new Employee(); int employee_id=Integer.parseInt(request.getParameter
        ("employee_id")); String male="" ; String female="" ; HashMap
        Values=employeeDetails.getEmployeeDetails(employee_id); if(Values.get("employee_gender").equals("Male")) {
        male="Selected" ; } else if(Values.get("employee_gender").equals("Female")) { female="Selected" ; } %>
        <script>
          jQuery(function () {
                    ...
                    <form action="model/employee.jsp" method="post">
                      ...
                      <div class="one_third first">
                        ...
                        <input type="text" name="employee_first_name" id="employee_first_name"
                          value="<% out.print(Values.get(" employee_first_name")); %>" size="22" required>
                      </div>
                      <div class="one_third">
                        <label for="email">Middle Name <span>*</span></label>
                        <input type="text" name="employee_middle_name" id="employee_middle_name"
                          value="<% out.print(Values.get(" employee_middle_name")); %>" size="22" required>
                      </div>
                      <div class="one_third">
                        <label for="url">Last Name</label>
                        <input type="text" name="employee_last_name" id="employee_last_name"
                          value="<% out.print(Values.get(" employee_last_name")); %>" size="22" required>
                      </div>
                      <div class="one_third first">
                        <label for="url">Gender</label>
                        <select style="height: 40px; width:100%" name="employee_gender" required>
                      ...
                      <div class="one_third">
                        ...
                        <input type="text" name="employee_dob" id="employee_dob" value="<% out.print(Values.get("
                          employee_dob")); %>" size="22" required>
                      </div>
                      <div class="one_third">
                        <label for="url">Nationality</label>
                        <input type="text" name="employee_nationalty" id="employee_nationalty"
                          value="<% out.print(Values.get(" employee_nationalty")); %>" size="22" required>
                      </div>

                      <div class="one_third first">
                        <label for="url">E-mail</label>
                        <input type="text" name="employee_email" id="employee_email" value="<% out.print(Values.get("
                          employee_email")); %>" size="22" required>
                      </div>
                      <div class="one_third">
                        <label for="url">Landline</label>
                        <input type="text" name="employee_landline" id="employee_landline"
                          value="<% out.print(Values.get(" employee_landline")); %>" size="22" required>
                      </div>
                      <div class="one_third">
                        <label for="url">Mobile</label>
                        <input type="text" name="employee_mobile" id="employee_mobile" value="<% out.print(Values.get("
                          employee_mobile")); %>" size="22" required>
                      </div>
                      ...
                      <div class="one_third first">
                        ...
                        <input type="text" name="employee_address" id="employee_address"
                          value="<% out.print(Values.get(" employee_address")); %>" size="22" required>
                      </div>
                      <div class="one_third">
                        <label for="url">Village/City/Town</label>
                        <input type="text" name="employee_village" id="employee_village"
                          value="<% out.print(Values.get(" employee_village")); %>" size="22" required>
                      </div>
                      <div class="one_third">
                        <label for="url">State</label>
                        <select style="height: 40px; width:100%" name="employee_state" required>
                          <% out.print(employeeDetails.getStateOption((Integer) Values.get("employee_state"))); %>
                        </select>
                      </div>
                      <div class="one_third first">
                        <label for="url">Country</label>
                        <select style="height: 40px; width:100%" name="employee_country" required>
                      ...
                      <% if(session.getAttribute("login_level") !=null &&
                        ...
                        <div class="one_third first">
                          ...
                          <select style="height: 40px; width:100%" name="employee_role" id="employee_role" required>
                            <% out.print(employeeDetails.getRoleOption((Integer) Values.get("employee_role"))); %>
                          </select>
                        </div>
                        <div class="one_third">
                          <label for="email">Manager Code<span>*</span></label>
                          <select style="height: 40px; width:100%" name="employee_manager_id" id="employee_manager_id"
                            required>
